...
<%def name="scripts()" filter="trim">
  ...
  <script type="text/javascript">
    ...
    function preDisplayPage() {
      ...
      resultsOnLoad.taux_imposition = Math.round(resultsOnLoad.impots_directs * 100 / (resultsOnLoad.impots_directs + resultsOnLoad.revenu_disponible));
    ...
    function callOpenFiscaAPI(callback) {
      ...
      var url = "https://fr.openfisca.org/api/v18/calculate";
...
<%def name="page_content()" filter="trim">
      ...
      <div class="row">
        <div class="col-md-12">
          <hr>
          <p>Ce simulateur utilise l'API Web OpenFisca avec OpenFisca-France</p>
          <hr>
        </div>
        <div class="col-md-12">
          <hr>
