...
<%inherit file="/france/fr/tree/installation.mako"/>
...
<%def name="block_windows()" filter="trim">
    ...
    <ul>
        ...
        <li>
            Install <a href="http://git-scm.com/download/win">Git</a>, open the .exe file and select default answers except for
