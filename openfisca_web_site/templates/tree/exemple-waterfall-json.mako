...
waterfallRactive.on('submit-form', function (event) {
...
##    }
    ...
    .fail(function(jqXHR, textStatus, errorThrown) {
        ...
        waterfallRactive.set('simulationError', jqXHR.responseText);
    });
...
<script id="waterfall-template" type="text/ractive">
    <h2>Décomposition en cascade d'une simulation</h2>
    <form class="form" role="form" on-submit="submit-form">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" rows="10" value="{{simulationText}}"></textarea>
            {{#simulationError}}
